...
get_ipython().system('pip -q install tensorflow~=2.14.0 model-compression-toolkit~=2.2.0 imx500-converter[tf]')
...
get_ipython().system('imxconv-tf -i {MODEL_KERAS} -o converted')
...
"""
get_ipython().system('ls converted')
