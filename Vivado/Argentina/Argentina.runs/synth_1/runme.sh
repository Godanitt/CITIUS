...
HD_PWD='/home/daniel/GitHub/CITIUS/Vivado/Argentina/Argentina.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Argentina.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Argentina.tcl
