...
#set_property -dict { PACKAGE_WPIN K2    IOSTANDARD LVCMOS33 } [get_ports { led3_b }]; #IO_L23P_T3_35 Sch=led3_b
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { LED3W }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
