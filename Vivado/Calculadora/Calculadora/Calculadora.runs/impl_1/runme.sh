...
HD_PWD='/home/daniel/GitHub/CITIUS/Vivado/Calculadora/Calculadora/Calculadora.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumador_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sumador_FPGA.tcl -notrace
