...
HD_PWD='/home/daniel/GitHub/CITIUS/Vivado/Calculadora/Calculadora/Calculadora.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sumador_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sumador_FPGA.tcl
